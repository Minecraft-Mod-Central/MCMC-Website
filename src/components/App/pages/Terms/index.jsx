  ...
  return (
    <>
      ...
      <p>
        ...
        conditions in full. Do not continue to use MCMC's website if you do not
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using MCMC's website you consent to the
        use of cookies in accordance with MCMC's privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, MCMC and/or it's licensors own the intellectual
        property rights for all material on MCMC. All intellectual property
        rights are reserved. You may view and/or print pages from
        https://mcmc.dev for your own personal use subject to restrictions set
      ...
      <p>
        Redistribute content from MCMC (unless content is specifically made for
        redistribution).
      </p>
      ...
      <p>
        ...
        MCMC; and (d) where the link is in the context of general resource
      ...
      <p>
        ...
        e-mail to{' '}<a href='mailto:latvianmodder@gmail.com' title='send an email to latvianmodder@gmail.com'>latvianmodder@gmail.com</a>
      ...
      <p>
        No use of MCMC's logo or other artwork will be allowed for linking
      ...
      <p>
        ...
        <a style={{ color: 'inherit', textDecoration: 'none', cursor: 'text' }} href='https://termsandconditionstemplate.com'>termsandconditionstemplate.com</a>{' '}
